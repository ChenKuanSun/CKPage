...
(function (root, factory) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        if(this.isSelect){
            ...
            var selectItem = '<select id="dateranepicker_select" class="form-control width150 select-item">';
            selectItem += '<option value="今日">今日</option>';
            selectItem += '<option value="昨日">昨日</option>';
            selectItem += '<option value="最近7日" >最近7日</option>';
            selectItem += '<option value="最近15日">最近15日</option>';
            selectItem += '<option value="最近30日" selected="selected">最近30日</option>';
            selectItem += '<option value="本月">本月</option>';
            selectItem += '<option value="上月">上月</option>';
            selectItem += '</select>';
